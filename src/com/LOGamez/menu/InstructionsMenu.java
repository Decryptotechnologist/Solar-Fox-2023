...
public class InstructionsMenu extends Menu {
    ...
    */
    ...
    public void render(Game game, Graphics2D g) {
        ...
        g.drawImage(instructionsMenuImage, 0, -15, SolarFox2023.getMainWidth(), SolarFox2023.getMainHeight()-20, null);
        ...
        if(MouseInput.MouseX > 500 && MouseInput.MouseX < 500 + 80 && MouseInput.MouseY > 630 && MouseInput.MouseY < 630 + 30) {
            ...
            //Set Status Bar: Back
            SolarFox2023.setStatusBar("Back");
            ...
            SolarFox2023.setStatusBar("Help Menu");
        }
